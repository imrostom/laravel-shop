        ...
        <div class="widget span3 red" onTablet="span6" onDesktop="span3">
            ...
            <div class="content">
                ...
                <div class="browserStat big">
                    <img src="<?php echo asset('public/admin') ?>/img/browser-chrome-big.png" alt="Chrome">
                    <span>34%</span>
                </div>
                <div class="browserStat big">
                    <img src="<?php echo asset('public/admin') ?>/img/browser-firefox-big.png" alt="Firefox">
                    <span>34%</span>
                </div>
                <div class="browserStat">
                    <img src="<?php echo asset('public/admin') ?>/img/browser-ie.png" alt="Internet Explorer">
                    <span>34%</span>
                </div>
                <div class="browserStat">
                    <img src="<?php echo asset('public/admin') ?>/img/browser-safari.png" alt="Safari">
                    <span>34%</span>
                </div>
                <div class="browserStat">
                    <img src="<?php echo asset('public/admin') ?>/img/browser-opera.png" alt="Opera">
                    <span>34%</span>
                </div>	
        ...
        <div class="box black span4" onTablet="span6" onDesktop="span4">
            ...
            <div class="box-content">
                <ul class="dashboard-list metro">
                    <li class="green">
                        <a href="#">
                            <img class="avatar" alt="Dennis Ji" src="<?php echo asset('public/admin') ?>/img/avatar.jpg">
                        </a>
